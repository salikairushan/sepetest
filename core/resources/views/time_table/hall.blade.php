            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-4">
                                <select class="selectpicker show-tick" id="hall">
                                    ...
                                    <option value="{{$i}}">{{$i}} Hall</option>
                                    @endfor
                                </select>
                            </div>
                            <button type="button" class="btn btn-primary waves-effect" onclick="filterHall()">Filter
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="body">
                        ...
                        <div id="hall_time_table_progress" class="progress" style="display: none;margin: 10px 20px;">
                        </div>
