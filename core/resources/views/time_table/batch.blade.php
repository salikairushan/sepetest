            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-4">
                                <select class="selectpicker show-tick" id="year">
                            ...
                            <div class="col-sm-4">
                                <select class="selectpicker show-tick" id="batch">
                                    <option value="1">1<sup>st</sup> Batch</option>
                                    <option value="2">2<sup>nd</sup> Batch</option>
                                    {{--<option value="3">3<sup>rd</sup> Batch</option>--}}
                                </select>
                            </div>
                            <button type="button" class="btn btn-primary waves-effect" onclick="filterBatch()">Filter
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="body">
                        ...
                        <div id="batch_time_table_progress" class="progress" style="display: none;margin: 10px 20px;">
                        </div>
